package de.unistuttgart.iaas.messaging.eventsourcemessaging.configuration;

import java.time.ZonedDateTime;
import java.util.Objects;

import de.unistuttgart.iaas.messaging.eventsourcemessaging.model.AccessToken;
import de.unistuttgart.iaas.messaging.eventsourcemessaging.model.ApiToken;
...
public class IBMQTokenChecker {
    ...
    @Before("execution(* de.unistuttgart.iaas.messaging.eventsourcemessaging.api.IBMQClient.*(..))")
