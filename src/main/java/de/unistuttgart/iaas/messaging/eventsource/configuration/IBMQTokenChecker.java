package de.unistuttgart.iaas.messaging.eventsource.configuration;

import java.time.ZonedDateTime;
import java.util.Objects;

import de.unistuttgart.iaas.messaging.eventsource.model.AccessToken;
import de.unistuttgart.iaas.messaging.eventsource.model.ApiToken;
...
public class IBMQTokenChecker {
    ...
    @Before("execution(* de.unistuttgart.iaas.messaging.eventsource.api.IBMQClient.*(..))")
